...
const SECTIONS = [
  {
    t: '一、服务说明',
    p: 'ChefPal 是一款 AI 烹饪助手微信小程序，提供 AI 问答学厨艺、食材推荐菜谱、收藏管理等功能。使用本服务即表示你同意本协议全部条款。',
  },
  {
    t: '二、账号与登录',
  ...
  {
    t: '三、AI 生成内容免责',
    p: '菜谱与问答内容由 AI 大模型生成，仅供烹饪参考，不构成医疗、营养或健康处方。涉及过敏原、疾病、孕期等特殊场景，请咨询专业医生或营养师。实际烹饪请以食材新鲜度与安全为准。',
  },
  {
    t: '四、用户行为规范',
  ...
  {
    t: '五、账号注销',
    p: '你可在「我的-注销账号」发起注销。注销后，你的收藏、问答历史、生成的菜谱及 AI 调用记录将被永久删除且无法恢复。注销操作不可撤销，请谨慎操作。',
  },
  {
    t: '六、协议变更',
